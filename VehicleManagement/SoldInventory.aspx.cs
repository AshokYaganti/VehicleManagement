        ...
        if (dt != null)
            if (dt.Rows.Count > 0)
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    sb.Append("<a href='SoldInventoryView.aspx?id=" + dr["inventoryid"] + "'' class='btn btn-primary btn-xs viewcls' style='text-decoration:none'>View</a>");
                    sb.Append("</td>");                  
