...
using System.Text;
public partial class AdminInventoryView : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        DAL obj1 = new DAL();
            ...
            int res = obj1.sellInventory(inventoryid);
            if (res > 0)
            {
                ClientScript.RegisterStartupScript(Page.GetType(), "Message", "alert('Inventory has been updated');window.location='AdminHome.aspx';", true);
            }
            else
            {
                ...
                Response.Redirect(ResolveUrl("AdminHome.aspx"));
            }
        }    
}