        ...
        try
        {
            ...
            if (ds1 != null && ds1.Tables[0].Rows.Count > 0)
            {
                for (i = 0; i < ds1.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (i == 1)
                    {
                        Image2.ImageUrl = "~/Handler1.ashx?imageid1=" + ds1.Tables[0].Rows[i]["imageid"];
                    }
                    if (i == 2)
                    {
                        Image3.ImageUrl = "~/Handler2.ashx?imageid2=" + ds1.Tables[0].Rows[i]["imageid"];
                    }
                    if (i == 3)
                    {
                        Image4.ImageUrl = "~/Handler3.ashx?imageid3=" + ds1.Tables[0].Rows[i]["imageid"];
                    }
