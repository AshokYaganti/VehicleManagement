<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage3.master" AutoEventWireup="true" CodeFile="AdminInventoryView.aspx.cs" Inherits="AdminInventoryView" %>

<asp:Content ID="Content1" ContentPlaceHolderID="right" Runat="Server">
   
<form id="Form123" class="form-horizontal" runat="server">
 <asp:Button ID="Button1" runat="server" Text="Sold out" style="margin-left:85%;" class="btn btn-md btn-primary right" onclick="Button1_Click" />
    ...
    <div class="ibox-content">
        <div class="form-group">
            <asp:Image ID="Image1" class="col-md-3" runat="server" ImageUrl='<%# "~/Handler.ashx?imageid=" + Eval("imageid")%>'/>
            <asp:Image ID="Image2" runat="server" class="col-md-3" ImageUrl='<%# "~/Handler1.ashx?imageid1=" + Eval("imageid")%>'/>
            <asp:Image ID="Image3" runat="server" class="col-md-3" ImageUrl='<%# "~/Handler2.ashx?imageid2=" + Eval("imageid")%>'/>
            <asp:Image ID="Image4" runat="server" class="col-md-3" ImageUrl='<%# "~/Handler3.ashx?imageid3=" + Eval("imageid")%>'/>
