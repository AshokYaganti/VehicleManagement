...
public partial class MyAccount : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (res > 0)
            {
                ClientScript.RegisterStartupScript(Page.GetType(), "Message", "alert('Your account has been updated.');window.location='MyAccount.aspx';", true);
            }
            else
            {
                ...
                Response.Redirect(ResolveUrl("MyAccount.aspx"));
            }
